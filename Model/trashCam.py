...
ip_webcam_url = "http://172.20.10.3:8080/video"  # Your phone's IP Webcam address
print("Attempting to connect to IP Webcam at:", ip_webcam_url)
cap = cv2.VideoCapture(ip_webcam_url)

model_path = os.path.join(os.path.dirname(__file__), '..', 'Model', 'Workspace', 'Trained Models', 'bests.pt')
